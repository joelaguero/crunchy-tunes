...
const SongPlayer = ({ track }) => {
  ...
  switch (track.apiSource) {
    case 'Spotify':
      ...
      break;
    case 'SoundCloud':
      embed = <audio id="player" autoPlay crossOrigin="anonymous" controls src={`http://api.soundcloud.com/tracks/${track.contentId}/stream?client_id=${keys.soundCloud}`}></audio>;
      break;
    case 'YouTube':
